...
import { createYear, toDate, createYearRange } from "reka-ui/date"
    ...
    <CalendarHeader>
      <CalendarHeading class="flex w-full items-center justify-between gap-2">
        ...
        >
          ...
          <SelectContent class="max-h-[200px]">
            <SelectItem
              v-for="yearValue in createYearRange({ start: date.add({ years: props.yearRange[0] }), end: date.add({ years: props.yearRange[1] }) })"
