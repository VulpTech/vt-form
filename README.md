# VT Form
Create a dynamic & reactive form with built-in validation by only defining a [Zod](https://v3.zod.dev/) (v3) schema. Uses [shadcn-vue](https://www.shadcn-vue.com/) components.
...
[Zod](https://v3.zod.dev/) (v3) is also required to define schemas:
```bash
npm install zod@3
```
or
